...
const DirectCollectibleSaleSnapUpResupply = artifacts.require('DirectCollectibleSaleSnapUpResupply');
const FractionalExponents = artifacts.require('FractionalExponents');

const { ZERO_ADDRESS } = require('@openzeppelin/test-helpers').constants;

contract('DirectCollectibleSaleSnapUpResupply', ([alice, bob, carol, dave, edith, fred, manager, minter, salter]) => {
  ...
  beforeEach(async () => {
    ...
    this.sale = await DirectCollectibleSaleSnapUpResupply.new(this.token.address, this.fexp.address, ZERO_ADDRESS);
  ...
  it('createItem should revert for non-managers', async () => {
    ...
    await expectRevert(
      ...
      "DirectCollectibleSaleSnapUpResupply: must have MANAGER role to create item"
    );
  });
  ...
  context('with items for sale', () => {
    ...
    it('setItemSupply reverts for non-manager', async () => {
      ...
      await expectRevert(
        ...
        "DirectCollectibleSaleSnapUpResupply: must have MANAGER role to set item supply or pricing"
      );
    ...
    it('setItemSupply reverts for invalid itemId', async () => {
      ...
      await expectRevert(
        ...
        "DirectCollectibleSaleSnapUpResupply: invalid itemId"
      );
