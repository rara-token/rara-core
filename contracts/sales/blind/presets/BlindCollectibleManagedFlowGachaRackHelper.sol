...
import "./BlindCollectibleManagedFlowGachaRack.sol";
...
contract BlindCollectibleManagedFlowGachaRackHelper is Context, AccessControlEnumerable {
    ...
    function createActivatedGame(
        ...
        BlindCollectibleManagedFlowGachaRack rack = BlindCollectibleManagedFlowGachaRack(gachaRack);

        // create
        gameId = rack.createGame(_drawPrice, _blocksToReveal);

        // set flow and supply
        rack.setGameDrawFlowAndSupply(
            gameId,
            _prizeSupply,
            _prizeFlowNumerator,
